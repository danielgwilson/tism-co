...
export default function ResultsPage() {
  ...
  const [loadingStep, setLoadingStep] = useState('📊 Reading your tweets...');
  ...
  useEffect(() => {
    const generateScore = async () => {
      try {
        ...
        setError(error instanceof Error ? error.message : 'Failed to generate score. Please try again.');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const shareText = scoreData ? `I got ${scoreData.totalScore}/800 on my 'TISM Score! My autism energy is off the charts 💀🧠\n\nScore yours: tism.co` : '';
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
          <div className="text-center space-y-8 max-w-md mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 text-8xl animate-pulse opacity-40 blur-sm">🧠</div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-lg text-gray-300 font-medium">{loadingStep}</p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="text-purple-400 font-mono font-bold">{loadingProgress}%</span>
                </div>
          ...
          <div className="text-center space-y-8 max-w-md mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="backdrop-blur-xl bg-red-500/10 border border-red-500/20 rounded-2xl p-6">
                <p className="text-gray-300 text-sm leading-relaxed">
                  {error?.includes('verified profiles') 
                    ...
                    : error || 'Something went wrong while analyzing this profile'
                  }
                </p>
              </div>
              ...
              <div className="space-y-3 pt-4">
                ...
                >
                  <Link href="/arthurmacwaters">✨ See Arthur&apos;s Score</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto p-4 space-y-8">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2 text-xs">
                    <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 border border-white/20">
                      <span className="text-gray-300">{scoreData?.profileData?.stats?.followers || '0'}</span>
        ...
        <div className="text-center space-y-6 pt-4">
          <div className="space-y-3">
            ...
            <div className="relative inline-block">
              <div className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-purple-600 animate-pulse">
              ...
              {/* Glow effect */}
              <div className="absolute inset-0 text-7xl font-black text-purple-400/20 blur-lg">
                {scoreData.totalScore}
              </div>
            </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="flex items-center gap-3 mb-8">
            <div className="text-3xl">📊</div>
            <h2 className="text-2xl font-black text-purple-400">CATEGORY BREAKDOWN</h2>
          </div>
                  ...
                  <div className="text-right space-y-2">
                    ...
                    <div className="w-16 bg-gray-700/50 rounded-full h-1">
                      <div 
                        ...
                        style={{ width: `${scoreData.categories[category.key]}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          >
            <a href={shareUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3">
        ...
        <div className="text-center space-y-3 pb-12 pt-8">
          <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2">
            <span className="text-xs text-gray-400">Built for AWS MCP Agents Hackathon 2025</span>
          </div>
          <p className="text-xs text-gray-500">🚀 Viral autism awareness through savage humor</p>
        </div>
      </div>
    </div>
  );
